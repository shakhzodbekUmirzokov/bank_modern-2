...
const Hero = () =>  (
    ...
    ${styles.paddingY}`}>
      ...
      flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        w-full">
          <h1 className="flex-1 font-poopin font-semibold
        ...
        <h1 className="font-poopin font-semibold
          ss:text-[68px] text-[52px] text-white ss:leading-[100px]
          leading-[75px]  w-full">Payment Method.
        </h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Our team of experts uses a mothodology to  fit your needs.
      ...
      <div className={`flex-1 ${styles.flexCenter} md:my-0
        my-10 relative`}>
